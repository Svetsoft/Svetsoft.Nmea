...
{
    /// <summary>
    ///     Represents a sentence of the NMEA specification for bearing and distance to waypoint (Great Circle).
    /// </summary>
    public class BwcSentence : NmeaSentence, IUtcTimeSentence, IWaypointSentence, ITrueBearingSentence, IMagneticBearingSentence
    {
        /// <summary>
        ///     Creates a new instance of the <see cref="BwcSentence" /> class.
        /// </summary>
        /// <param name="sentence">The sentence to create the instance from.</param>
        public BwcSentence(string sentence)
            : base(sentence)
        {
            Parse();
        }
        ...
        /// <summary>
        ///     Parses the fields of this sentence to its <see cref="BwcSentence" /> equivalent.
        /// </summary>
        private void Parse()
        {
