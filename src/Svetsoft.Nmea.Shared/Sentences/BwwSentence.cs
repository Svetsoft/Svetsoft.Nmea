namespace Svetsoft.Nmea
{
    ...
    /// </summary>
    public class BwwSentence : NmeaSentence, ITrueBearingSentence, IMagneticBearingSentence
    {
        /// <summary>
        ///     Creates a new instance of the <see cref="BwwSentence" /> class.
        /// </summary>
        /// <param name="sentence">The sentence to create the instance from.</param>
        public BwwSentence(string sentence)
            : base(sentence)
        {
            Parse();
        }
        ...
        /// <summary>
        ///     Parses the fields of this sentence to its <see cref="BwwSentence" /> equivalent.
        /// </summary>
        private void Parse()
        {
