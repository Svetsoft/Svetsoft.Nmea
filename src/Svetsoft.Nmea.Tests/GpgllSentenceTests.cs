...
namespace Svetsoft.Geography.Positioning.Tests
{
    ...
    public class GpgllSentenceTests
    {
        ...
        {
            var gpgllSentence = NmeaSentence.ParseGpgll("$GPGLL,3751.65,S,14507.36,E,180133.35*7B");
        ...
        {
            var result = NmeaSentence.TryParseGpgll("$GPGLL,3751.65,S,14507.36,E,180133.35*7B", out GpgllSentence gpgllSentence);
